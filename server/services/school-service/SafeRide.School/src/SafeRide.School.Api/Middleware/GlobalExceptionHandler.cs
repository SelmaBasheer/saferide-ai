...
using SafeRide.School.Api.Common;
using SafeRide.School.Application.Common.Exceptions;
using SafeRide.School.Domain.Exceptions;
using SafeRide.School.Infrastructure.Exceptions;

namespace SafeRide.School.Api.Middleware;
